...
public class Convertor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Celsius To Fahrenheit Convertor");

        jLabel1.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel1.setText("Celsius");

        cField.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        ...
        fField.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel4.setText("Fahrenheit");

        clBtn.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        clBtn.setText("Clear");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cField, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(convertBtn)
                .addGap(18, 18, 18)
                .addComponent(fField, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void convertBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertBtnActionPerformed
        ...
        fah = (int)(celsius * (9.0 / 5) + 32);

        
        fField.setText(Double.toString(fah));
